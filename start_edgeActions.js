...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${sterne_zwilling_klein}", "click", function(sym, e) {
         sym.$("sternenGruppe").css({'pointer-events': 'none'});
         sym.play("zwilling");
         sym.getParentSymbol().$("cosmos").animate({scrollTop: 0, scrollLeft: 0}, 2000, "swing");
      ...
      Symbol.bindElementAction(compId, symbolName, "${cosmos_neu}", "click", function(sym, e) {
         ...
         //sym.playReverse();
         sym.$("sternenGruppe").css({'pointer-events': 'auto'});
         sym.stop("anfang2");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 8249, function(sym, e) {
         sym.getParentSymbol().$("cosmos_neu").css({'pointer-events': 'auto'});
